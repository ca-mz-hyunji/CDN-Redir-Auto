...
def findBaseHost(virt_hosts, logging_file_path):
    ...
    ### FOR LOCAL TESTING
    # Mac: json_file = '/Users/hyunjikim/Desktop/GitHub/CDN-final/testing_files/setting.json'
    # Windows:
    json_file = 'C:\\Users\\Kim\\Desktop\\GitHub\\CDN-final\\testing_files\\setting.json'
